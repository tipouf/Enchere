							...
							<div class="row">
								<div class="col-4">
									<input type="checkbox" id="EncheresEncours"
										name="enchereEnCours"> <label>Mes ench�res en
										cours</label>
								</div>

								<div class="col-4">
									<input type="checkbox" id="venteNonDebutees"
										name="ventesNonDebut�es"> <label>Ventes non
										d�but�es</label>
								</div>
							</div>
							<div class="row">
								<div class="col-4">
									<input type="checkbox" id="encheresRemportees"
										name="enchereRemportees"> <label>Mes ench�res
										remport�es</label>
								</div>

								<div class="col-4">
									<input type="checkbox" id="venteTerminees"
										name="venteTerminees"> <label>Vente termin�es</label>
								</div>
							</div>
						</c:if>
			</div>
